    ...
    <GuestLayout>
        ...
        <form @submit.prevent="submit" class="max-w-xl">
            ...
            <div class="mt-4 ">
                ...
                <datepicker v-model="form.birthday" name="birthday" placeholder="DD-MM-YYYY">
                </datepicker>
                <InputError class="mt-2" :message="form.errors.birthday" />
            </div>

            <div class="mt-4">
                <InputLabel for="avatar" value="Choose Your avatar" />
                <Input id="avatar" type="file" @input="handleImageChange" />
